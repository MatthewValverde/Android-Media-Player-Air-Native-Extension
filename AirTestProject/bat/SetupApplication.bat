...
:: Android packaging
set AND_CERT_NAME="AirMediaPlayerApp"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AirMediaPlayerApp.p12
...
set IOS_PROVISION=cert\AirMediaPlayerApp.mobileprovision
...
set APP_ID=com.ane.mediaplayer.app

:: Output packages
set DIST_PATH=dist
set DIST_NAME=AirMediaPlayerApp
